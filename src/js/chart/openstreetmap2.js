  ...
  // 시청 마커 추가
  var cityhallLatLng = L.latLng(37.5665, 126.9780); // 위도, 경도 좌표
  var cityhallMarker = L.marker(cityhallLatLng).addTo(map);

  // 종로구 통일로 246-20, 107동 마커 추가
  var jongroLatLng = L.latLng(37.5753, 126.9603); // 위도, 경도 좌표
  var jongroMarker = L.marker(jongroLatLng).addTo(map);
